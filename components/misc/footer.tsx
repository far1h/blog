...
<ul className="flex space-x-6 mb-4 md:order-1">
            <li>
              <Link href="mailto:farih.muhammad@binus.ac.id" aria-label="Email">
                <FaEnvelope className="w-8 h-8 text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out" />
              </Link>
            </li>
            <li>
              <Link href="https://linkedin.com/in/farihmhmd" aria-label="LinkedIn">
                <FaLinkedin className="w-8 h-8 text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out" />
              </Link>
            </li>
            <li>
              <Link href="https://github.com/far1h" aria-label="GitHub">
                <FaGithub className="w-8 h-8 text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out" />
              </Link>
            </li>
          </ul>
